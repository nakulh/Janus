...
public class Route {
    ...
    private final List<LatLng> startLocation;
    private final List<LatLng> endLocation;
    ...
    public void addStartLocation(final List<LatLng> startLocation) {
        this.startLocation.addAll(startLocation);
    }
    ...
    public void addEndLocation(final List<LatLng> endLocation) {
        this.endLocation.addAll(endLocation);
    }

    public void setManeuver(final String maneuver) {
        this.maneuver.add(maneuver);
    }

    public List<String> getManeuver() {
        return maneuver;
    }
